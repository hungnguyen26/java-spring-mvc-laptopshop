            ...
            <div class="mt-5">
                <div class="row">
                    <div class="col-md-6 col-12 mx-auto">
                        ...
                        <hr/>
                        <form:form method="post" enctype="multipart/form-data" action="/admin/user/create" modelAttribute="newProduct" class="row">
                            ...
                            <div class="mb-3 col-12 ">
                                <label for="form-label">Detail description</label>
                            ...
                            <div class="mb-3 col-12 col-md-6">
                                <label for="form-label">Target:</label>
